...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        tools:targetApi="33">
        <activity
            android:name=".ItineraryAdapter"
            android:exported="false" />
        <activity
            android:name=".ItineraryItem"
            android:exported="false" />
        <activity
        ...
        <activity
            ...
            android:exported="false" /> <!-- Adjusted targetApi to a more common recent value like 33 or 34, change if needed -->
        <!-- Splash Activity is the ONLY LAUNCHER -->
        <activity
            android:name=".SplashActivity"
            android:exported="true"
            android:theme="@style/Theme.AlayaApp.SplashImitation"> <!-- Apply Splash Theme Here -->
            <intent-filter>
        ...
        <activity
            ...
            android:exported="false" /> <!-- MainActivity - REMOVED as LAUNCHER and set to not exported -->
        <!-- If you plan to DELETE MainActivity.java later, you can remove this block entirely -->
        <activity
...
public class ItinerariesActivity extends AppCompatActivity implements ItineraryAdapter.OnStartDragListener { // Implement listener
    ...
    private void setupBottomNavListener() {
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            Intent intent = null;
            boolean slideRightToLeft = true;

            if (destinationItemId == R.id.navigation_home) {
                intent = new Intent(getApplicationContext(), HomeActivity.class);
                slideRightToLeft = getItemIndex(destinationItemId) > getItemIndex(CURRENT_ITEM_ID);
...
<androidx.constraintlayout.widget.ConstraintLayout
    ...
    <ScrollView
        ...
        <LinearLayout
            ...
            <!-- ... (Itineraries Title, Current Location Title, Location Box) ... -->
            <TextView
            ...
            <!-- Suggested Itinerary Title Area -->
            <LinearLayout
                android:layout_width="match_parent"
                android:layout_height="wrap_content"
                ...
                <!-- Save Changes Text (Initially Hidden) -->
                <TextView
            ...
            <!-- Suggested Itinerary RecyclerView -->
            ...
            <!-- ... (Recommended Other Title, GridLayout) ... -->
            <TextView
